...
gulp.task('watch', function() {
	gulp.watch([srcPath + '/**/*.scss', srcPath + '/**/*.css'], ['build-styles']);
	gulp.watch([srcPath + '/assets/js/**/*.js'], ['build-scripts', 'browser-reload']);
	gulp.watch([srcPath + '/assets/vendor/**/*.js', srcPath + '/assets/js/vendor.js'], ['build-scripts-vendor', 'browser-reload']);
	gulp.watch(srcPath + '/**/*.html', ['build-templates', 'browser-reload']);
